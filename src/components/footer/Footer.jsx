    ...
    return (
        <footer className="flex p-2 bg-background-footer text-text-ligth justify-between items-center lg:flex-row flex-col mt-auto">
            ...
            <div className="flex m-2 pl-10">
                <p className="flex">
                    ©Copyright 2023 C.I Autopartes Radcars S.A.S Teléfonos de
                    Contacto: 316 366 0784 3216988321 | Correo Eletrónico:
                    radcars@hotmail.com | Dirección: Av 6a # 0-95 La Merced,
                    Cúcuta, Norte de Santander | By Agencia Cavel
                </p>
            </div>
