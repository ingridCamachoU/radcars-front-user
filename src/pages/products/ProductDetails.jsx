            ...
            <div className="w-full max-w-screen-xl">
                        ...
                        <div className="flex flex-col gap-2 mt-4">
                            ...
                            <p>
                                ...
                                <span className="font-light">
                                    {product.mark_model?.mark.name}
                                </span>
                            </p>
                            <p>
                                -Modelo:{' '}
                                <span className="font-light">
                                    {product.mark_model?.name}
                                </span>
                            </p>
                            <p>
                                -Transmisión:{' '}
                ...
                <section className="m-2 p-2">
                    ...
                    <p className="font-ligth">
                        Compra en Autopartes Radcars. La mejor opción en
                        repuestos y autopartes para tu vehículo. Nuestra tienda
                        cuenta con repuestos originales y homologados de las
                        principales marcas de vehículos: Chevrolet, Mazda, Ford,
                        Hyundai, Kia, Renault, Volkswagen, Nissan, Suzuki,
                        Isuzu. ENVÍOS A TODO EL PAIS ✈️ 🌍. aplican resticciones
                        en tarifas. despacho inmediato y sin recargo. LÍNEA DE
                        ATENCIÓN: WhatsApp 📲 321 698 8321 CAMBIOS, DEVOLUCIONES
                        Y GARANTÍAS: Estos productos tienen una garantía de tres
                        meses calendario (90 días), partes eléctricas y bombas
                        de gasolina una garantía de diez (10) días calendario.
                        Para baterías La garantía se aplica conforme se
                        establece en el certificado de garantia entregado junto
                        con la batería en el momento de la compra. Los productos
                        deben presentarse en su empaque original y sin
                        instalación previa en el vehículo. No presentar
                        deterioro, rayones, fisuras, ni alteración de ningún
                        tipo. Comunícate con nuestra línea de atención para
                        programar tu cambio o devolución. Encuentra también tus
                        autopartes de: accesorios, caja y transmisión,
                        carrocería, clutch, correas, dirección y suspensión,
                        eléctricos, filtración, frenado, iluminación,
                        lubricantes, motor, refrigeración.
                    </p>
                </section>
