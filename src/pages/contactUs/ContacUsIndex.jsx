                        ...
                        <div className="mt-4 flex gap-2 flex-col">
                            <p>
                                <span className="font-light flex items-center gap-2">
                                    <MapPinIcon className="h-4 w-4 text-text-blue" />
                                    Nuestros Punto de Venta:
                                </span>
                                <span className="font-light">
                                    Av 6a # 0-95 La Merced, Cúcuta, Norte de
                                    Santander.
                                </span>
                            </p>
                            <p>
                                <span className="font-light flex items-center gap-2">
                                    <EnvelopeIcon className="h-4 w-4 text-text-blue" />
                                    Correo Electrónico:
                                </span>
                                <span className="font-light">
                                    radcars@hotmail.com
                            ...
                            <p>
                                <span className="font-light flex items-center gap-2">
                                    <PhoneIcon className="h-4 w-4 text-text-blue" />
                                    Atención al Cliente
                                </span>
                                <span className="font-light">
                                    316 366 0784/ 3216988321
                                </span>
                            </p>
                        </div>
                    </div>
