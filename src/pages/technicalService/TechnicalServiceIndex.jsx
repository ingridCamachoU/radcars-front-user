            ...
            <div className="max-w-screen-xl">
                <section className="w-full flex lg:flex-row flex-col mt-4 p-2 gap-6">
                    <div className="lg:w-2/4 w-full justify-center flex flex-col gap-2 sm:px-6 px-1 items-center">
                        ...
                        <CardService
                            title={'Venta y reparación de radiadores'}
                            urlImg={radiador}
                            altImg={'radiador'}
                        />
                        <CardService
                    ...
                    <div className="lg:w-2/4 w-full flex flex-col sm:px-6 px-1">
                        ...
                        <div className="mt-6 font-light">
                            <p className="flex gap-2 items-center mb-2 ">
                                <span>
                                    <WrenchScrewdriverIcon className="h-4 w-4 text-text-blue" />
                                </span>
                            ...
                            <p className="flex gap-2 items-center mb-4">
                                ...
                                Cambio y reparación de partes originales y
                                homologadas.
                            </p>
                            ...
                            <p className="flex gap-2 items-center mb-4">
                                ...
                                Diseño y adaptaciones de radiadores.
                            </p>
                            ...
                            <p className="flex gap-2 items-center mb-4">
                                ...
                                Fabricación y distribución de tanques
                                troquelados, industriales, súper industriales,
                                panales tropicalizados y corrientes.
                            </p>
                            ...
                            <p className="flex gap-2 items-center mb-4">
                                ...
                                Servicio de soldaduras especiales (TIG, MIG,
                            ...
                            <p className="flex gap-2 items-center mb-4">
                                ...
                                Limpieza de sistemas de refrigeración, usando
